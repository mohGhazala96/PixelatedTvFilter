...
public class PixelHandler : MonoBehaviour
{
    ...
    IEnumerator Loop()
    {
        ...
        if (ConfigurationsManager.Instance.force == Force.FallBack)
        {
            GetComponent<Rigidbody>().AddForce(new Vector3(0, 0, Random.Range(-1, -10)) * 10, ForceMode.Impulse);
        ...
        {
            GetComponent<Rigidbody>().AddForce(new Vector3(Random.Range(-10, 10), Random.Range(-10, 10), Random.Range(-10, 10)) * 10, ForceMode.Impulse);
